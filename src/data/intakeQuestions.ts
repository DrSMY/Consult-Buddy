...
export const intakeQuestions: IntakeQuestion[] = [
  ...
  { id: "cancer_history", section: "Health Status & Medical Background", question: "Have you or anyone in your close family ever been diagnosed with cancer or any type of tumor/growth?", type: "select", options: ["No", "Yes - myself", "Yes - a family member", "Yes - both myself and a family member"], hasNotes: true },
