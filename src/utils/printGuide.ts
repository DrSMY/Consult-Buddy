...
const SECTION_COLORS: Record<string, { bg: string; border: string; headerBg: string; text: string; dot: string }> = {
  INTRODUCTION:                  { bg: "#d5f5f0", border: "#0d9488", headerBg: "#a7f3d0", text: "#0f766e", dot: "#14b8a6" },
  "PATIENT SUMMARY":             { bg: "#d0e4ff", border: "#3b82f6", headerBg: "#b6d4fe", text: "#1d4ed8", dot: "#3b82f6" },
  "STORAGE INSTRUCTIONS":        { bg: "#c8f5fa", border: "#06b6d4", headerBg: "#a5f0fb", text: "#0e7490", dot: "#06b6d4" },
  "HOW TO INJECT":               { bg: "#d6daff", border: "#6366f1", headerBg: "#c0c5ff", text: "#4338ca", dot: "#6366f1" },
  "HOW TO TAKE YOUR MEDICATION": { bg: "#d6daff", border: "#6366f1", headerBg: "#c0c5ff", text: "#4338ca", dot: "#6366f1" },
  "NUTRITION & DIET PLAN":       { bg: "#d0f5dc", border: "#22c55e", headerBg: "#b0ecc4", text: "#15803d", dot: "#22c55e" },
  "DIETARY ADVICE":              { bg: "#d0f5dc", border: "#22c55e", headerBg: "#b0ecc4", text: "#15803d", dot: "#22c55e" },
  "COMMON SIDE EFFECTS":         { bg: "#fef0c7", border: "#f59e0b", headerBg: "#fde68a", text: "#b45309", dot: "#f59e0b" },
  "RED-FLAG SYMPTOMS":           { bg: "#ffd6d9", border: "#f43f5e", headerBg: "#fbb6bd", text: "#be123c", dot: "#f43f5e" },
  "FOLLOW-UP PLAN":              { bg: "#e0d6ff", border: "#8b5cf6", headerBg: "#cbbdfe", text: "#6d28d9", dot: "#8b5cf6" },
  "PHYSICAL ACTIVITY":           { bg: "#c8f5e0", border: "#10b981", headerBg: "#a7f3d0", text: "#047857", dot: "#10b981" },
  "CONSISTENCY & MINDSET":       { bg: "#e8d5ff", border: "#a855f7", headerBg: "#d8b4fe", text: "#7e22ce", dot: "#a855f7" },
  "HYDRATION & RECOVERY":        { bg: "#c8e8ff", border: "#0ea5e9", headerBg: "#a5d8fe", text: "#0369a1", dot: "#0ea5e9" },
  "YOUR PRESCRIBED MEDICATIONS": { bg: "#d0e4ff", border: "#3b82f6", headerBg: "#b6d4fe", text: "#1d4ed8", dot: "#3b82f6" },
  "RECOMMENDED SUPPLEMENTS":     { bg: "#fef0c7", border: "#f59e0b", headerBg: "#fde68a", text: "#b45309", dot: "#f59e0b" },
  "REQUIRED LAB TESTS":          { bg: "#c8f5fa", border: "#06b6d4", headerBg: "#a5f0fb", text: "#0e7490", dot: "#06b6d4" },
  "IMPORTANT REMINDERS":         { bg: "#ffd6d9", border: "#f43f5e", headerBg: "#fbb6bd", text: "#be123c", dot: "#f43f5e" },
  "LIFESTYLE TIPS":              { bg: "#c8f5e0", border: "#10b981", headerBg: "#a7f3d0", text: "#047857", dot: "#10b981" },
  "SCHEDULE & TIMING":           { bg: "#e0d6ff", border: "#8b5cf6", headerBg: "#cbbdfe", text: "#6d28d9", dot: "#8b5cf6" },
  "REFILL SUMMARY":              { bg: "#d0e4ff", border: "#3b82f6", headerBg: "#b6d4fe", text: "#1d4ed8", dot: "#3b82f6" },
  "MEDICATION REMINDER":         { bg: "#fef0c7", border: "#f59e0b", headerBg: "#fde68a", text: "#b45309", dot: "#f59e0b" },
};
